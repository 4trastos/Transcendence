...
export class Card extends Component {
    ...
    renderTemplate() {
        return `
        <div class="backdrop-3xl bg-opacity-15 bg-[#1D1F2B] ${this.props.width} ${this.props.height} border border-white border-opacity-15 rounded-2xl shadow-lg flex flex-col overflow-hidden">
        <!-- Header del chat -->	
