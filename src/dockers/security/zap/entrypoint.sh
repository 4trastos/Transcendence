...
# Iniciar OWASP ZAP
/zap/zap.sh -daemon -host 0.0.0.0 -port 8081 -config api.key=my_zap_api_key -config api.addrs.addr.name=.* -config api.addrs.addr.regex=true
...
export ZAP_API_KEY="my_zap_api_key"
/zap/wrk/zap_scan.sh
